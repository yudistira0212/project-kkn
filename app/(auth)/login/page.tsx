          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <div className="flex justify-between items-center">
                ...
                <Link
                  href={"/"}
                  className="text-white hover:bg-slate-200 hover:text-black h-fit w-fit rounded-md"
                >
                  <svg
              ...
              <form onSubmit={handleSubmit} className="max-w-sm mx-auto">
                ...
                <button
                  ...
                  className="text-white disabled:bg-opacity-50 disabled:cursor-wait bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
