...
import Iamge6 from "@/app/images/Lambang_Kabupaten_Manokwari_Selatan.png";
import Image from "next/image";
const Footer = () => {
  return (
    <footer className="md:flex  py-[30px] items-center px-8 bg-[#0B3147] text-white">
      <div className="w-full flex gap-5 items-center md:w-2/3 ">
        <Image
          src={Iamge6}
          alt="logo"
          width={80}
        ...
        />
        <div>
          <h1 className=" font-semibold">{/* {profil.title} */}Kampung siwi</h1>
          <p>
            {/* {profil.alamat} */}
            Alamat
            <br />
